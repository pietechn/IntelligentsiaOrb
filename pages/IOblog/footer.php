		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4 footer-grid-agileits-w3ls text-left">
					...
					<div class="read">
						<a href="https://intelligentsiaorb.com/pages/about.php" class="btn btn-primary read-m">Read More</a>
					</div>
				</div>
				<div class="col-lg-4 footer-grid-agileits-w3ls text-left">
			...
			<div class="footer-cpy text-center">
				...
				<div class="w3layouts-agile-copyrightbottom">
					<p>  <?php $current=date("Y"); print_r($current);?> | Brought To You by
						<a href="http://intelligentsiaorb.com/">intelligentsiaorb WorldWide LTD</a>
					</p>
