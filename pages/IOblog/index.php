...
<head>
    <!--google adsense-->
    <script data-ad-client="ca-pub-6602011993054031" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
					...
					<!-- <section class="middle-sec-agileinfo-w3ls">
						<div class="container">
							<div class="row inner-sec">
								...
								<div id="dmo1_main_image" class="col-md-8  news-right"></div>
