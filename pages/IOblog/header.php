			...
			<div class="row">
				<div class="col-md-4 logo text-left">
					<a class="navbar-brand" href="index.php">
						<span><img src=""></span> INTELLIGENTSIAORB BLOG</a>
				</div>
				...
				<div class="col-md-4 log-icons text-right">
					...
					<ul class="social_list1 mt-3">
						...
						<li>
							<a href="<?php getlinks("links","linkedin");?>" class="dribble3 mx-2">
								<i class="fab fa-linkedin"></i>
							</a>
						</li>
						<li>
							<a href="<?php getlinks("links","instagram");?>" class="pin">
				...
				<nav class="navbar navbar-expand-lg navbar-light bg-light">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							...
							<li class="nav-item">
								<a class="nav-link" href="https://intelligentsiaorb.com/pages/about.php">About</a>
							</li>
