<?php
	$dbServer = 'localhost';
	$dbUsername = 'u693573209_consultancy';
	$dbPassword = 'IntelligentsiaOrb1234567890';
	$dbDatabase = 'u693573209_intelligentsia';

	$adminConfig = array(
		'adminUsername' => "admin",
		'adminPassword' => "ca68a6a5484cb51ad114111a1b8596d4",
